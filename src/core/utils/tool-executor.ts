/**
 * 文件作用：工具执行与参数修复工具函数（core 层）。
 * 仅依赖 core 层接口与 contracts，可被 domain 层安全调用。
 */
import type { IToolRegistry } from "../ports/tool-registry.js";
import type { ToolExecuteResult } from "../../contracts/agent.js";
import type { ILogger } from "../ports/logger.js";
import { tryParseJson, safeJsonStringify } from "./text-utils.js";
